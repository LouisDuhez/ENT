...
<head>
    ...
    <title>Absences/retards - ENT</title>
                    ...
                    <div class="task">
                        ...
                        <?php if ($absence['abs_justif'] == 0): ?>
                          <form action="control.php?action=justifAbsence" method="POST" enctype="multipart/form-data">
                              ...
                              <input type="file" id="justif_file" name="justif_file" required>
                              
                              <button type="submit" class="button-abs">Envoyer</button>
                          </form>
